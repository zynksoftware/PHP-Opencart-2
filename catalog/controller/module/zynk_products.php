...
class ZynkProducts extends Controller 
{
    ...
    public function SetProduct($product)
    {
        ...
        if($this->config->get('zynk_upload_cost_price'))
        {
...
//echo("query: $query </br>");
    ...
    public function GetTaxClass($TaxCode){
        ...
        if(!$tax_class)
        {
            ...
            $TaxCode = $this->config->get('zynk_default_taxcode');
    ...
    private function MatchTaxClass($TaxCode, $default = NULL){
        switch ($TaxCode)
        {
            case $this->config->get('zynk_vatable_taxcode'):
                    $tax_class = $this->config->get('zynk_vatable_taxclass');
                    break;
            case $this->config->get('zynk_nonvatable_taxcode'):
                    $tax_class = $this->config->get('zynk_nonvatable_taxclass');
                    break;

            case $this->config->get('zynk_exempt_taxcode'):
                    $tax_class = $this->config->get('zynk_exempt_taxclass');;
                    break;
